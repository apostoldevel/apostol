...
- [PQFetch](https://github.com/apostoldevel/module-PQFetch) (Postgres Query Fetch);
    * Предоставляет возможность проектировать бизнес логику серверного приложения (backend) на языке программирования PL/pqSQL непосредственно в самой базе данных.
