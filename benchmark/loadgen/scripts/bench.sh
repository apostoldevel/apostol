...
#   --quick              Quick mode: 10s, fewer configs
#
...
if [ "$QUICK" = true ]; then
  CONFIGS=("2:100" "4:1000")
else
  CONFIGS=("2:100" "4:1000" "8:5000" "10:10000")
fi
...
for target_key in v0-nginx v1-apostol v2-python v3-node v4-go; do
